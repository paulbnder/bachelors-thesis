...
data = xr.open_dataset("data-2012-08-07-01-1_1(0.488IOU).nc")
predictions_netcdf = xr.open_dataset('class_masks_data-2012-08-07-01-1_1.nc')
lat = data.lat[:]
lon = data.lon[:]-180
...
plt.savefig('data-2012-08-07-01-1_1(0_488IOU)',  dpi=1000, bbox_inches='tight')
mng.full_screen_toggle()
